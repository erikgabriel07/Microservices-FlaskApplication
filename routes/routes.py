...
def register_routes(app: Flask, logger: Logger, thread_processor: ThreadProcessing):
    ...
    #duplicado ou deletado base incidencia -->> ligma
    ...
    def duplicatedORdeleted(user_id=None):
        ...
        if not data:
            return jsonify({'message': 'Not found ID'}), 404
        ...
        return jsonify({'message': 'Only supported with "duplicated" or "deleted" parameter'}), 500


    #ching ling competencia
